...
#     path = param_list.get('download_path')
    ...
    logging.info("checking directory path " , type(arxiv_directory_path_data),arxiv_directory_path_data)
    ...
    last_load = get_last_load(arxiv_directory_path_data, timestamp_file)
...
def persist(param_list):
    ...
    if not call(["hdfs", "dfs", "-test", "-d", arxiv_hadoop_directory]):
