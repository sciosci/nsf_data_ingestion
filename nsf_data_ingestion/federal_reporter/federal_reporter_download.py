...
#     if last_load >= 604800:
    if last_load >= 8400000:
        ...
        for i in range(2004, 2017):
            ...
            os.system(
                'wget ' + param_list.get('FedRePORTER_PRJ_url') +str(i)+ '.zip -nv -P ' + federal_directory_path_data)
            os.system(
                'wget ' + param_list.get('FedRePORTER_PRJABS_url') +str(i)+ '.zip -nv -P ' + federal_directory_path_data)
