...
Grants = pd.read_csv('FedRePORTER_PRJ_C_FY2014.csv', header=None, names=colnames, encoding = "ISO-8859-1")
...
Grants_abs = pd.read_csv('FedRePORTER_PRJABS_C_FY2014.csv', header=None, names=colnames_abs, encoding = "ISO-8859-1")
...
document_merge.to_csv('Grants_Document_2014.csv', index=False) 
...
# creating a new csv and writing the contents from data frame
my_dataframe_scientist_final.to_csv('Grants_Scientist_2014.csv', index=False) 
...
# creating a new csv and writing the contents from data frame
my_dataframe_org.to_csv('Grants_Organizational_2014.csv', index=False) 
...
get_ipython().system('hdfs dfs -put Grants_Document_2014.csv            ')
get_ipython().system('hdfs dfs -put Grants_Scientist_2014.csv')
get_ipython().system('hdfs dfs -put Grants_Organizational_2014.csv')
...
document_csv = pd.read_csv('Grants_Document_2014.csv')
...
document_spark_df.write.parquet('Grant_Document_2014.parquet')
...
# Reading the csv file format
scientist_csv = pd.read_csv('Grants_Scientist_2014.csv')
...
# convert it to parquet format
scientist_spark_df.write.parquet('Grant_Scientist_2014.parquet')
...
# Reading the csv file format
org_csv = pd.read_csv('Grants_Organizational_2014.csv')
...
# convert it to parquet format
org_spark_df.write.parquet('Grant_Organization_2014.parquet')
